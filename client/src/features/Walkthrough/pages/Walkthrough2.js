...
const Walkthrough2 = ({ navigation }) => {
	return (
		<View style={{ flex: 1, justifyContent: "space-between", padding: 24 }}>
			...
			<Headings title='Explora lecciones interactivas' description='Descubre lecciones intuitivas y prácticas sobre educación financiera a tu propio ritmo'></Headings>
