...
const Walkthrough3 = ({ navigation }) => {
	return (
		<View style={{ flex: 1, justifyContent: "space-between", padding: 24 }}>
			...
			<Headings title='Realiza un seguimiento de tu progreso' description='Mantén un registro de tus logros y observa cómo mejoras tus habilidades financieras con el tiempo'></Headings>
			<View style={{ gap: 16 }}>
