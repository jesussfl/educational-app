...
const WorldCard = ({ name, description, imgSource, mainAction, isCompleted, isLocked, worldsCompleted, isCurrent }) => {
   ...
   return (
      <View
         ...
         <Text style={{ fontFamily: "Sora-SemiBold", textAlign: "center", fontSize: 18, color: isLocked ? Colors.gray_400 : Colors.gray_600}}>Lecciones completadas: {worldsCompleted}</Text>
         </View>
      </View>
   );
};
