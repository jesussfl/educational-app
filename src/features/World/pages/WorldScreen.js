...
const WorldScreen = ({ navigation }) => {
	...
	return (
		<BottomSheetModalProvider>
			...
			<BottomSheetModal ref={bottomSheetModalRef} index={1} snapPoints={snapPoints} onChange={(index) => handleSheetChanges(index)} enableOverDrag={true} enableDismissOnClose={true} enablePanDownToClose={true}>
